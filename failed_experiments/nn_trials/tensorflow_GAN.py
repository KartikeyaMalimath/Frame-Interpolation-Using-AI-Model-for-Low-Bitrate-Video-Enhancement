...
# frames = []
# for i in range(len(os.listdir('/kaggle/input/data-set'))):
#     frame = cv2.imread(os.path.join('/kaggle/input/data-set', f'frame_{i}.png'))
#     frames.append(frame)
#
...
#
# if not os.path.exists("/kaggle/working/data_reduced"):
#     os.makedirs("/kaggle/working/data_reduced")
#
# # Save the frames to a new folder.
# for i in range(len(frames)):
#     cv2.imwrite(os.path.join('/kaggle/working/data_reduced', f'frame_{i:03d}.png'), frames[i])
#
# # Load the frames from the data_reduced folder.
# frames = []
# for i in range(len(os.listdir('/kaggle/working/data_reduced'))):
#     frame = cv2.imread(os.path.join('/kaggle/working/data_reduced', f'frame_{i:03d}.png'))
#     frames.append(frame)
...
def preprocess_data(images, labels, augment=False):
    labels = tf.one_hot(labels, NUM_CLASSES) # one-hot encode the labels
